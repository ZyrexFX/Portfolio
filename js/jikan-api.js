...
.then(response => {
    ...
    .then(response => {
        ...
        document.getElementById('act1').src=`${response.data.images.jpg.image_url}`
    ...
    .then(response => {
        ...
        document.getElementById('act2').src=`${response.data.images.jpg.image_url}`
    ...
    .then(response => {
        ...
        document.getElementById('act3').src=`${response.data.images.jpg.image_url}`
